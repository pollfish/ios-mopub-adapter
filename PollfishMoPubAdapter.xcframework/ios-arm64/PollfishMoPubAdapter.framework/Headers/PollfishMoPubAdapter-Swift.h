...
#ifndef POLLFISHMOPUBADAPTER_SWIFT_H
#define POLLFISHMOPUBADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PollfishMoPubAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20PollfishMoPubAdapter28PollfishAdapterConfiguration")
@interface PollfishAdapterConfiguration : MPBaseAdapterConfiguration
@property (nonatomic, readonly, copy) NSString * _Nonnull adapterVersion;
@property (nonatomic, readonly, copy) NSString * _Nullable biddingToken;
@property (nonatomic, readonly, copy) NSString * _Nonnull moPubNetworkName;
